...
/*
    List<Opportunity> findBySalesRepOpportunity(SalesRep salesRepOpportunity);
    ...
    List<Opportunity> findBySalesRepOpportunityAndStatusEquals(SalesRep salesRepOpportunity, Status status);
